...
#[cfg(not(feature = "cuda"))]
type RiscvSdk = powdr_openvm::PowdrSdkCpu<powdr_openvm_riscv::RiscvISA>;

#[cfg(feature = "cuda")]
type RiscvSdk = powdr_openvm::PowdrSdkGpu<powdr_openvm_riscv::RiscvISA>;

const APP_PK_FILE: &str = "app_pk.bin";
const AGG_PK_FILE: &str = "agg_pk.bin";
const COMPILED_PROGRAM_FILE: &str = "compiled_program.bin";
