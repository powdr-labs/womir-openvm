...
mod tests {
    ...
    fn test_shl_imm() {
        ...
        // 0xFF << 8 = 0xFF00
        let spec = TestSpec {
            program: vec![wom::shl_imm::<F>(1, 0, 8_i16)],
            start_fp: 10,
    ...
    fn test_shr_s_imm() {
        ...
        let spec = TestSpec {
            program: vec![wom::shr_s_imm::<F>(1, 0, 4_i16)],
            start_fp: 10,
    ...
    fn test_shr_s_imm_positive() {
        ...
        let spec = TestSpec {
            program: vec![wom::shr_s_imm::<F>(1, 0, 8_i16)],
            start_fp: 10,
    ...
    fn test_shr_s_imm_64() {
        ...
        let spec = TestSpec {
            program: vec![wom::shr_s_imm_64::<F>(2, 0, 4_i16)],
            start_fp: 124,
            start_registers: vec![
                (124, 0),
                (125, 0x80000000), // reg 0 = 0x8000_0000_0000_0000
    ...
    fn test_shr_s_imm_64_positive() {
        ...
        let spec = TestSpec {
            program: vec![wom::shr_s_imm_64::<F>(2, 0, 8_i16)],
            start_fp: 124,
            start_registers: vec![
                (124, 0),
