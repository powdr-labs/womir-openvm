...
pub type BaseAluAir = VmAirWrapper<
    BaseAluAdapterAir<RV32_REGISTER_NUM_LIMBS>,
    BaseAluCoreAir<RV32_REGISTER_NUM_LIMBS, RV32_CELL_BITS>,
>;
...
pub type BaseAlu64Air = VmAirWrapper<
    BaseAluAdapterAir<REGISTER_NUM_LIMBS_64>,
    BaseAluCoreAir<REGISTER_NUM_LIMBS_64, RV32_CELL_BITS>,
>;
