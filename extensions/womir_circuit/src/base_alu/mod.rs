...
pub type Rv32BaseAluExecutor = BaseAluExecutor<RV32_REGISTER_NUM_LIMBS, 1, RV32_CELL_BITS>;
...
pub type BaseAlu64Chip<F> =
    VmChipWrapper<F, BaseAluFiller<BaseAluAdapterFiller<2, 2, RV32_CELL_BITS>, 8, RV32_CELL_BITS>>;
