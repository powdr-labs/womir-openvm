...
pub type Rv32LessThanExecutor =
    LessThanExecutor<RV32_REGISTER_NUM_LIMBS, W32_REG_OPS, W32_REG_OPS, RV32_CELL_BITS>;
...
pub type LessThan64Executor =
    LessThanExecutor<W64_NUM_LIMBS, W64_REG_OPS, W32_REG_OPS, RV32_CELL_BITS>;
