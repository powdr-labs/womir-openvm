...
pub type Rv32EqExecutor =
    EqExecutor<RV32_REGISTER_NUM_LIMBS, W32_REG_OPS, W32_REG_OPS, RV32_CELL_BITS>;
...
>;
pub type Eq64Executor = EqExecutor<W64_NUM_LIMBS, W64_REG_OPS, W32_REG_OPS, RV32_CELL_BITS>;
