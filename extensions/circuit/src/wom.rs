use openvm_stark_backend::{interaction::{BusIndex, InteractionBuilder, PermutationCheckBus}, p3_field::{FieldAlgebra, PrimeField32}};
...
impl<F: PrimeField32> WomController<F> {
    ...
    pub fn read<const N: usize>(&self, pointer: F) -> [F; N] {
        ...
        self.memory.iter().skip(ptr_u32 as usize).take(N).map(|f| f.expect("WOM read before write")).collect_array().expect("WOM read before write")
    }
    ...
    pub fn write<const N: usize>(&mut self, pointer: F, data: [F; N]) {
        ...
        self.memory.iter_mut().skip(ptr_u32 as usize).take(N).zip_eq(data).for_each(|(old, new)| {
...
mod test {
    ...
    fn test_wom_read_before_write2() {
        ...
        // write to addr 4
        wom.write(BabyBear::from_canonical_u32(4), [BabyBear::from_canonical_u32(1), BabyBear::from_canonical_u32(2), BabyBear::from_canonical_u32(3), BabyBear::from_canonical_u32(4)]);
        // read addr 0
        wom.read::<4>(BabyBear::from_canonical_u32(0));
    }
    ...
    fn test_wom_double_write() {
        ...
        wom.write(BabyBear::from_canonical_u32(0), [BabyBear::from_canonical_u32(1), BabyBear::from_canonical_u32(2), BabyBear::from_canonical_u32(3), BabyBear::from_canonical_u32(4)]);
        wom.write(BabyBear::from_canonical_u32(0), [BabyBear::from_canonical_u32(5), BabyBear::from_canonical_u32(6), BabyBear::from_canonical_u32(7), BabyBear::from_canonical_u32(8)]);
    }

    #[test]
    fn test_wom_write_read() {
        let mut wom = WomController::<BabyBear>::new(PermutationCheckBus::new(0));
        let w1 = [BabyBear::from_canonical_u32(1), BabyBear::from_canonical_u32(2), BabyBear::from_canonical_u32(3), BabyBear::from_canonical_u32(4)];
        let w2 = [BabyBear::from_canonical_u32(5), BabyBear::from_canonical_u32(6), BabyBear::from_canonical_u32(7), BabyBear::from_canonical_u32(8)];
