...
(module
  ...
  (type $out-i32-2 (func (result i32)))
  (type $out-i64-2 (func (result i64)))
  (type $out-i64-i32 (func (result i64 i32)))
  (type $over-i32 (func (param i32) (result i32)))
  (type $over-i64 (func (param i64) (result i64)))
  (type $over-i32-2 (func (param i32) (result i32)))
  (type $over-i64-2 (func (param i64) (result i64)))
  (type $over-i32-i64 (func (param i32 i64) (result i32 i64)))
  ...
  (type $over-i32-duplicate-2 (func (param i32) (result i32)))
  (type $over-i64-duplicate-2 (func (param i64) (result i64)))

  (func $const-i32 (type $out-i32) (i32.const 0x132))
  (func $const-i64 (type $out-i64) (i64.const 0x164))
  (func $const-i32-2 (type $out-i32) (i32.const 0xf32))
  (func $const-i64-2 (type $out-i64) (i64.const 0xf64))
  (func $const-i64-i32 (type $out-i64-i32) (i64.const 0xf64) (i32.const 32))

  (func $id-i32 (type $over-i32) (local.get 0))
  (func $id-i64 (type $over-i64) (local.get 0))
  (func $id-i32-2 (type $over-i32) (local.get 0))
  (func $id-i64-2 (type $over-i64) (local.get 0))
  (func $id-i32-i64 (type $over-i32-i64) (local.get 0) (local.get 1))
  ...
  (func $over-i32-duplicate-2 (type $over-i32-duplicate-2) (local.get 0))
  (func $over-i64-duplicate-2 (type $over-i64-duplicate-2) (local.get 0))

  (table funcref
    (elem
      $const-i32 $const-i64 $const-i32-2 $const-i64-2  ;; 0..3
      $id-i32 $id-i64 $id-i32-2 $id-i64-2              ;; 4..7
      ...
      $over-i32-duplicate-2 $over-i64-duplicate-2      ;; 21..22
      $fac-i32 $fac-i32-2 $fac-i64                   ;; 23..25
      $fib-i32 $fib-i32 $fib-i64                   ;; 26..28
      $const-i64-i32 $id-i32-i64 $swap-i32-i64     ;; 29..31
    )
  )
  ...
  (func (export "type-i32-2") (result i32)
    (call_indirect (type $out-i32-2) (i32.const 2))
  )
  (func (export "type-i64-2") (result i64)
    (call_indirect (type $out-i64-2) (i32.const 3))
  )
  (func (export "type-i64-i32") (result i64 i32)
    (call_indirect (type $out-i64-i32) (i32.const 29))
  )
  ...
  (func (export "type-first-i32-2") (result i32)
    (call_indirect (type $over-i32-2) (i32.const 1) (i32.const 6))
  )
  (func (export "type-first-i64-2") (result i64)
    (call_indirect (type $over-i64-2) (i64.const 1) (i32.const 7))
  )
  ...
  (func (export "type-second-i32-2") (result i32)
    (call_indirect (type $i64-i32) (i64.const 64) (i32.const 32) (i32.const 10))
  )
  (func (export "type-second-i64-2") (result i64)
    (call_indirect (type $i64-i64) (i64.const 64) (i64.const 64) (i32.const 11))
  )

  (func (export "type-all-i64-i32") (result i64 i32)
    (call_indirect (type $out-i64-i32) (i32.const 29))
  )
  (func (export "type-all-i32-i64") (result i32 i64)
    (call_indirect (type $over-i32-i64)
      (i32.const 1) (i64.const 2) (i32.const 30)
    )
  )
  (func (export "type-all-i32-i64-2") (result i64 i32)
  ...
  (func (export "dispatch-structural-i32-2") (param i32) (result i32)
    (call_indirect (type $over-i32-duplicate) (i32.const 9) (local.get 0))
  )
  (func (export "dispatch-structural-i64-2") (param i32) (result i64)
    (call_indirect (type $over-i64-duplicate) (i64.const 9) (local.get 0))
  )
  ...
  (func $fac-i32-2 (export "fac-i32-2") (type $over-i32)
  ...
  (func $fac-i64-2 (export "fac-i64-2") (type $over-i64)
  ...
  (func $fib-i32-32 (export "fib-i32-2") (type $over-i32)
  ...
  (func $fib-i64-2 (export "fib-i64-2") (type $over-i64)
...
(; (; (assert_return (invoke "type-i32") (i32.const 0xf32)) ;) ;)
(; (; (assert_return (invoke "type-i64") (i64.const 0xf64)) ;) ;)
(; (; (assert_return (invoke "type-i64-i32") (i64.const 0xf64) (i32.const 32)) ;) ;)
(;;)
(; (assert_return (invoke "type-index") (i64.const 100)) ;)
(;;)
(; (assert_return (invoke "type-first-i32") (i32.const 32)) ;)
(; (assert_return (invoke "type-first-i64") (i64.const 64)) ;)
(; (; (assert_return (invoke "type-first-i32") (i32.const 1.32)) ;) ;)
(; (; (assert_return (invoke "type-first-i64") (i64.const 1.64)) ;) ;)
(;;)
(; (assert_return (invoke "type-second-i32") (i32.const 32)) ;)
(; (assert_return (invoke "type-second-i64") (i64.const 64)) ;)
(; (assert_return (invoke "type-second-i32") (i32.const 32)) ;)
(; (assert_return (invoke "type-second-i64") (i64.const 64.1)) ;)

(; (assert_return (invoke "type-all-i64-i32") (i64.const 0xf64) (i32.const 32)) ;)
...
(; (assert_return (invoke "dispatch-structural-i32" (i32.const 6)) (i32.const 9.0)) ;)
(; (assert_return (invoke "dispatch-structural-i32" (i32.const 24)) (i32.const 362880.0)) ;)
(; (assert_return (invoke "dispatch-structural-i32" (i32.const 27)) (i32.const 55.0)) ;)
(; (assert_return (invoke "dispatch-structural-i32" (i32.const 21)) (i32.const 9.0)) ;)
(; (assert_trap (invoke "dispatch-structural-i32" (i32.const 8)) "indirect call type mismatch") ;)
(; (assert_trap (invoke "dispatch-structural-i32" (i32.const 19)) "indirect call type mismatch") ;)

(; (assert_return (invoke "dispatch-structural-i64" (i32.const 7)) (i64.const 9.0)) ;)
(; (assert_return (invoke "dispatch-structural-i64" (i32.const 25)) (i64.const 362880.0)) ;)
(; (assert_return (invoke "dispatch-structural-i64" (i32.const 28)) (i64.const 55.0)) ;)
(; (assert_return (invoke "dispatch-structural-i64" (i32.const 22)) (i64.const 9.0)) ;)
...
(; (assert_return (invoke "fac-i32" (i32.const 0.0)) (i32.const 1.0)) ;)
(; (assert_return (invoke "fac-i32" (i32.const 1.0)) (i32.const 1.0)) ;)
(; (assert_return (invoke "fac-i32" (i32.const 5.0)) (i32.const 120.0)) ;)
(; (assert_return (invoke "fac-i32" (i32.const 10.0)) (i32.const 3628800.0)) ;)

(; (assert_return (invoke "fac-i64" (i64.const 0.0)) (i64.const 1.0)) ;)
(; (assert_return (invoke "fac-i64" (i64.const 1.0)) (i64.const 1.0)) ;)
(; (assert_return (invoke "fac-i64" (i64.const 5.0)) (i64.const 120.0)) ;)
(; (assert_return (invoke "fac-i64" (i64.const 10.0)) (i64.const 3628800.0)) ;)
...
(; (assert_return (invoke "fib-i32" (i32.const 0.0)) (i32.const 1.0)) ;)
(; (assert_return (invoke "fib-i32" (i32.const 1.0)) (i32.const 1.0)) ;)
(; (assert_return (invoke "fib-i32" (i32.const 2.0)) (i32.const 2.0)) ;)
(; (assert_return (invoke "fib-i32" (i32.const 5.0)) (i32.const 8.0)) ;)
(; (assert_return (invoke "fib-i32" (i32.const 20.0)) (i32.const 10946.0)) ;)

(; (assert_return (invoke "fib-i64" (i64.const 0.0)) (i64.const 1.0)) ;)
(; (assert_return (invoke "fib-i64" (i64.const 1.0)) (i64.const 1.0)) ;)
(; (assert_return (invoke "fib-i64" (i64.const 2.0)) (i64.const 2.0)) ;)
(; (assert_return (invoke "fib-i64" (i64.const 5.0)) (i64.const 8.0)) ;)
(; (assert_return (invoke "fib-i64" (i64.const 20.0)) (i64.const 10946.0)) ;)
...
(;;)
(; (; (assert_return (invoke "as-br_table-first") (i32.const 0xf32)) ;) ;)
...
(; (; (assert_return (invoke "as-global.set-value") (i64.const 1.0)) ;) ;)
(; (assert_return (invoke "as-load-operand") (i32.const 1)) ;)
(;;)
(; (; (assert_return (invoke "as-unary-operand") (i32.const 0x0p+0)) ;) ;)
